...
export const SAMPLER_PRESETS = {
    ...
    'tight-focus': {
        label: 'Tight Focus',
        family: 'Custom',
        note: 'Triple-filtered — tight K=25, cooled temp, light Top A',
        settings: {
            temp_openai: 0.95,
            freq_pen_openai: 0,
            pres_pen_openai: 0,
    ...
    'gentle-nudge': {
        label: 'Gentle Nudge',
        family: 'Custom',
        note: 'Light touch all-rounder — slightly cooled, gentle P trim + tail cut',
        settings: {
            temp_openai: 0.9,
            freq_pen_openai: 0,
            pres_pen_openai: 0,
    ...
    'ds-leash': {
        label: 'DS Leash',
        family: 'Custom',
        note: 'Penalty-heavy — every lever pulled to tame Deepseek',
        settings: {
            temp_openai: 0.8,
            freq_pen_openai: 0.1,
            pres_pen_openai: 0.05,
            top_p_openai: 0.95,
            top_k_openai: 0,
            repetition_penalty_openai: 1,
            min_p_openai: 0.05,
    ...
    'k-cap-only': {
        label: 'K-Cap Only',
        family: 'Community',
        note: 'From Lucid Loom — K=255 hard cap, everything else wide open',
        settings: {
            temp_openai: 1.0,
            freq_pen_openai: 0,
            pres_pen_openai: 0,
    ...
    'cool-tail-cut': {
        label: 'Cool Tail Cut',
        family: 'Community',
        note: 'From Chatfill — cooled temp + adaptive Top A tail pruning',
        settings: {
            temp_openai: 0.85,
            freq_pen_openai: 0,
            pres_pen_openai: 0,
    ...
    'unfiltered': {
        label: 'Unfiltered',
        family: 'Community',
        note: 'From Paramnesia — zero sampling intervention, raw model output',
        settings: {
            temp_openai: 1.0,
            freq_pen_openai: 0,
            pres_pen_openai: 0,
